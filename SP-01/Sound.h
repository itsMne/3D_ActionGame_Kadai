...
typedef enum
{
	...
	SOUND_LABEL_EASY,		// BGM0
	SOUND_LABEL_NORMAL,		// BGM0
	SOUND_LABEL_HARD,		// BGM0
	SOUND_LABEL_GAMEOVER,		// BGM0
	SOUND_LABEL_CLEAR,		// BGM0
	...
	SOUND_LABEL_SE_DAMAGE,			// 殴るSE
	SOUND_LABEL_SE_SLIDE,			// 殴るSE
	SOUND_LABEL_SE_DEFAULTPUNCH,			// 殴るSE
